...
class Dialog(val oldName: String, val oldUnit: Int, val changeProduct: (String, String, Int) -> (Unit)) : DialogFragment(){
    override fun onCreateView(
        ...
        view.productName.text.append(oldName)
        view.productUnits.text.append(oldUnit.toString())
